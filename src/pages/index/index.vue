<template>
  <view
    ...
    style="background: linear-gradient(180deg, #3e8fd4 0%, #f7fbfe 300rpx)"
  >
    <!-- 顶部区域 - 预算进度 -->
        ...
        <view class="flex items-center">
          ...
          <view class="relative flex-shrink-0" style="width: 160rpx; height: 160rpx">
            ...
            >
              ...
              >
                <text class="font-bold" style="font-size: 40rpx; color: #3e8fd4"
    ...
    <view
      ...
      style="
        width: 112rpx;
        height: 112rpx;
        background: linear-gradient(135deg, #3e8fd4 0%, #2e6fa8 100%);
        box-shadow: 0 8rpx 24rpx rgba(184, 169, 201, 0.4);
      "
      @click="goToAddPage"
    >
    ...
    <view class="px-4 mb-6">
      <text class="text-xl font-semibold text-gray-800 mb-4 block">日历视图</text>
      <view class="bg-white rounded-2xl p-5" style="box-shadow: 0 4rpx 20rpx rgba(0, 0, 0, 0.06)">
        ...
        <view class="calendar-grid">
          ...
          >
            ...
            <text v-if="day.expense > 0" class="day-expense">{{
